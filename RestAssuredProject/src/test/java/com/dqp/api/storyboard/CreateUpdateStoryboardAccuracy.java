...
public class CreateUpdateStoryboardAccuracy {
	...
	void updateStoryPUT() { //Replace newly generated storyboard_id wherever it as below code	
			...
			String idVal="215722";
			String storyboardName = "My Storyboard - Default - 23";
		
			RestAssured.given().contentType("application/json")
				.body("{\"storyboard_id\":"+idVal+",\"user_id\":1,\"project_id\":3,\"name\":"+storyboardName+",\"default_flag\":\"N\","
/* Replace id*/			+ "\"widgets\":[{\"widget_id\":211806,\"storyboard_id\":"+idVal+",\"pos_x\":0,\"pos_y\":0,\"width\""
...
/* Replace id*/			+ "\"storyboard_id\":"+idVal+",\"pos_x\":6,\"pos_y\":0,\"height\":4,\"width\":6},{\"x\":0,\"y\""
						...
						+ ":\"chart\"},\"cols\":6,\"rows\":4,\"user_defined\":\"Y\",\"deleted\":false,"
/* Replace id*/			+ "\"storyboard_id\":"+idVal+",\"pos_x\":0,\"pos_y\":4,\"height\":4,\"width\":6},{\"x\":6,\"y\""
						+ ":4,\"template_json\":{\"name\":\"PM-2505_accuracy_New_20\",\"id\":145296,\"dqType\""
						+ ":\"ACCURACY\",\"measureName\":\"PM-1068_accuracy_New\",\"measureId\":103285,\"widget_type\""
						+ ":\"chart\"},\"cols\":6,\"rows\":4,\"user_defined\":\"Y\",\"deleted\":false,"
/* Replace id*/			+ "\"storyboard_id\":"+idVal+",\"pos_x\":6,\"pos_y\":4,\"height\":4,\"width\":6},{\"x\":0,\"y\""
						+ ":8,\"template_json\":{\"name\":\"PM-2505_accuracy_New\",\"id\":145241,\"dqType\""
						+ ":\"ACCURACY\",\"measureName\":\"PM-1068_accuracy_New\",\"measureId\":103285,\"widget_type\""
						+ ":\"chart\"},\"cols\":6,\"rows\":4,\"user_defined\":\"Y\",\"deleted\":false,"
/* Replace id*/			+ "\"storyboard_id\":"+idVal+",\"pos_x\":0,\"pos_y\":8,\"height\":4,\"width\":6},{\"x\":6,\"y\""
						+ ":8,\"template_json\":{\"name\":\"PM-2506_accuracy_New\",\"id\":115954,\"dqType\""
						+ ":\"ACCURACY\",\"measureName\":\"PM-1068_accuracy_New\",\"measureId\":103285,\"widget_type\""
						+ ":\"chart\"},\"cols\":6,\"rows\":4,\"user_defined\":\"Y\",\"deleted\":false,"
/* Replace id*/			+ "\"storyboard_id\":"+idVal+",\"pos_x\":6,\"pos_y\":8,\"height\":4,\"width\":6},{\"x\":0,\"y\""
						+ ":12,\"template_json\":{\"name\":\"PM-2505_accuracy_N_times\",\"id\":115523,\"dqType\""
						+ ":\"ACCURACY\",\"measureName\":\"PM-1068_accuracy_New\",\"measureId\":103285,\"widget_type\""
						+ ":\"chart\"},\"cols\":6,\"rows\":4,\"user_defined\":\"Y\",\"deleted\":false,"
/* Replace id*/			+ "\"storyboard_id\":"+idVal+",\"pos_x\":0,\"pos_y\":12,\"height\":4,\"width\":6}]}")
