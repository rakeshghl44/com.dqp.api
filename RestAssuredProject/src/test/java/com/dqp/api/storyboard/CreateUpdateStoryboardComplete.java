...
public class CreateUpdateStoryboardComplete {
	...
	void updateStory() { //Replace newly generated storyboard_id wherever it as below code	
			...
			RestAssured.given().contentType("application/json")
				.body("{\"storyboard_id\":211798,\"user_id\":1,\"project_id\":3,\"name\":\"My Storyboard - Default - 22\","
						+ "\"default_flag\":\"N\",\"widgets\":[{\"widget_id\":211799,\"storyboard_id\":211798,\"pos_x\""
						...
						+ "\"storyboard_id\":211798,\"pos_x\":6,\"pos_y\":0,\"height\":4,\"width\":6},{\"x\":0,\"y\""
						...
						+ ":false,\"storyboard_id\":211798,\"pos_x\":0,\"pos_y\":4,\"height\":4,\"width\":6},{\"x\""
						...
						+ "\"storyboard_id\":211798,\"pos_x\":6,\"pos_y\":4,\"height\":4,\"width\":6},{\"x\":0,\"y\""
						+ ":8,\"template_json\":{\"name\":\"Online_Completeness_1\",\"id\":202887,\"dqType\":"
						+ "\"COMPLETENESS\",\"measureName\":\"Online_Completeness_1\",\"measureId\":202880,\"widget_type\""
						+ ":\"chart\"},\"cols\":6,\"rows\":4,\"user_defined\":\"Y\",\"deleted\":false,"
						+ "\"storyboard_id\":211798,\"pos_x\":0,\"pos_y\":8,\"height\":4,\"width\":6},{\"x\":6,\"y\""
						...
						+ "\"widget_type\":\"chart\"},\"cols\":6,\"rows\":4,\"user_defined\":\"Y\",\"deleted\":false,"
						+ "\"storyboard_id\":211798,\"pos_x\":6,\"pos_y\":8,\"height\":4,\"width\":6}]}")
				.post(RestAssured.baseURI + "/api/v1/storyboard").then().log().all();
